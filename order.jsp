...
<section class="tabless">
    ...
    <tr>
        <td>
            ...
            <input  type="checkbox" name="chk1" value="1" onchange="updatevalue(this);" class="ip">
            <hr> 
            <p class="word">
                Butter Tea<br>
                Rs.60/-
    ...
    <tr>
        <td>
            ...
            <a href="" class="crt"><img src="images/cart.jpg" id="myimg"></a>
            <input  type="checkbox" name="chk1" value="2" onchange="updatevalue(this);" class="ip">
            <hr>
            <p class="word">
                Almond cake<br>
                Rs.150/-
    ...
    <tr>
        <td>
            ...
            <a href="" class="crt"><img src="images/cart.jpg" id="myimg"></a>
            <input  type="checkbox" name="chk1" value="3" onchange="updatevalue(this);" class="ip">
            <hr>
            <p class="word">
            Veg Biryani<br>
            Rs.150/-
    ...
    <tr>
        <td>
            ...
            <a href="" class="crt"><img src="images/cart.jpg" id="myimg"></a>
            <input  type="checkbox" name="chk1" value="4" onchange="updatevalue(this);" class="ip">
            <hr>
            <p class="word">
                ButterScotch<br>
                Rs.100/-
    ...
    <tr>
        <td>
            ...
            <a href="" class="crt"><img src="images/cart.jpg" id="myimg"></a>
            <input  type="checkbox" name="chk1" value="5" onchange="updatevalue(this);" class="ip">
            <hr>
            <p class="word">
    ...
    <tr>
        <td>
            ...
            <a href="" class="crt"><img src="images/cart.jpg" id="myimg"></a>
            <input  type="checkbox" name="chk1" value="6" onchange="updatevalue(this);" class="ip">
            <hr>
            <p class="word">
                Banana Split<br>
                Rs.100/-
    ...
    <tr>
        <td>
            ...
            <a href="" class="crt"><img src="images/cart.jpg" id="myimg"></a>
            <input  type="checkbox" name="chk1" value="7" onchange="updatevalue(this);" class="ip">
            <hr>
            <p class="word">
                Chowmein<br>
                Rs.120/-
